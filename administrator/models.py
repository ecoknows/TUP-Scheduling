...
class SubjectsOrderable(Orderable):
    ...
    first_year_first_sem = ParentalKey("administrator.CourseCurriculum",
                                       related_name="first_year_first_sem", null=True)
    first_year_second_sem = ParentalKey("administrator.CourseCurriculum",
                                        related_name="first_year_second_sem", null=True)
    second_year_first_sem = ParentalKey("administrator.CourseCurriculum",
                                        related_name="second_year_first_sem", null=True)
    second_year_second_sem = ParentalKey("administrator.CourseCurriculum",
                                         related_name="second_year_second_sem", null=True)
    third_year_first_sem = ParentalKey("administrator.CourseCurriculum",
                                       related_name="third_year_first_sem", null=True)
    third_year_second_sem = ParentalKey("administrator.CourseCurriculum",
                                        related_name="third_year_second_sem", null=True)
    fourth_year_first_sem = ParentalKey("administrator.CourseCurriculum",
                                        related_name="fourth_year_first_sem", null=True)
    fourth_year_second_sem = ParentalKey("administrator.CourseCurriculum",
