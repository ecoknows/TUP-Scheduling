...
class SubjectsOrderable(Orderable):
    subject_model = ParentalKey(
        "administrator.Subjects", related_name="subject_parental_key", null=True)
    professor_model = ParentalKey("accounts.Professors",
                                  related_name="professor_parental_key", null=True)
    course_curriculum_model1 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="first_year_first_sem", null=True)
    course_curriculum_model2 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="first_year_second_sem", null=True)
    course_curriculum_model3 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="second_year_first_sem", null=True)
    course_curriculum_model4 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="second_year_second_sem", null=True)
    course_curriculum_model5 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="third_year_first_sem", null=True)
    course_curriculum_model6 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="third_year_second_sem", null=True)
    course_curriculum_model7 = ParentalKey("administrator.CourseCurriculum",
                                           related_name="fourth_year_first_sem", null=True)
    course_curriculum_model8 = ParentalKey("administrator.CourseCurriculum",
...
#         "administrator.Departments", related_name="department_parental_key", null=True)

#     college = models.ForeignKey(
#         "administrator.Colleges",
#         null=True,
#         on_delete=models.CASCADE,
#         blank=False,
#     )
...
class DepartmentOrderable(Orderable):
    college_model = ParentalKey(
        "administrator.Colleges", related_name="college_parental_key", null=True)
...
class Sections(models.Model, index.Indexed):
    ...
    course_curriculum = models.ForeignKey(
        "administrator.CourseCurriculum",
        null=True,
        on_delete=models.CASCADE,
